      ...
      <div class="modal-body">
        <div class="">
          ...
          <div class="form-group has-success__">
            ...
            <input type="text" class="form-control form-control-success" id="inputSuccess1" value="<?php echo "Voilà le détail de votre ".strtolower($orderDetail["Type_Piece"])." n°".$orderDetail["Code_Commande"]." @ La Parqueterie Nouvelle" ?>" name="subject">
            <!--<div class="form-control-feedback">Success! You've done it.</div>
            <small class="form-text text-muted">Example help text that remains unchanged.</small>-->
           </div>
