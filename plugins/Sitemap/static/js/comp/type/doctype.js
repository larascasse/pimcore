pimcore.registerNS("sitemap.comp.type.doctype");
sitemap.comp.type.doctype = Class.create(sitemap.comp.type.base,{
    ...
    onAfterPopulate: function(){
        var isRule = Ext.getCmp("isRule");
        isRule.setValue(true);
    ...
    getForm: function($super){
        ...
        var thisNode = new Ext.form.FieldSet({
            ...
            items :[{
                ...
                minChars: 1,
                removeValuesFromStore:false,
                fieldLabel: t("Choose the doctype"),
                name: "doctype",
                store: pimcore.globalmanager.get("document_types_store"),
                displayField: 'name',
                valueField: 'id'
