...
foreach ($list->getObjects() as $object) {
    ...
    switch ($epaisseur) {
         ...
         case 22:
            ...
            if($object->getPimonly_classe_utilisation()=="") {
                $object->setValue('pimonly_classe_utilisation',41);
            }
        ...
        case 15:
            ...
            if($object->getPimonly_classe_utilisation()=="") {
                $object->setValue('pimonly_classe_utilisation',34);
            }
        ...
        case 17 :
            ...
            $object->setPose(array('acoller'));
            if($object->getPimonly_classe_utilisation()=="") {
                $object->setValue('pimonly_classe_utilisation',31);
            }
