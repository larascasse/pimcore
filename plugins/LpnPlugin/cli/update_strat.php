...
foreach ($list->getObjects() as $object) {
    ...
    if(stristr($scienergie, "(CHA)")) {
        $parentSuffixeEan .= " - Château 8 G4 -";
    }
    else if(stristr($scienergie, "(lop)")) {
        $parentSuffixeEan .= " - Loft Project 8 -";
    }
    else  if(stristr($scienergie, "(FL)")) {
        $parentSuffixeEan .= " - Firstline -";
    }
    else  if(stristr($scienergie, "(FIRPRO)")) {
        $parentSuffixeEan .= " - Firstline -";
    }
    else  if(stristr($scienergie, "(IMP)")) {
        if(stristr($scienergie, "G2")) {
            $parentSuffixeEan .= " - Impulse 8 G2 -";
        }
        else if(stristr($scienergie, "G4")) {
    ...
    else  if(stristr($scienergie, "(sm7)")) {
        $parentSuffixeEan .= " - Smart 7 -";
    }
    else  if(stristr($scienergie, "(sm8)")) {
        $parentSuffixeEan .= " - Smart 8 -";
    }
    else  if(stristr($scienergie, "(ETELO)")) {
        $parentSuffixeEan .= " - Eternity Long 12 G4 -";
    }
    else  if(stristr($scienergie, "(ETE)")) {
        ...
        $parentSuffixeEan .= " - Impulse G4 -";
    }
    else  if(stristr($scienergie, "(OCEV4)")) {
