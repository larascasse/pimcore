pimcore.registerNS("sitemap.comp.type.docfolder");
sitemap.comp.type.docfolder = Class.create(sitemap.comp.type.base,{
    ...
    getForm: function($super){
        ...
        var labelStore = new Ext.data.ArrayStore({
            fields: ['id', 'label'],
            data : [['property','Custom property'],['label','Define label']]
        });
                    ...
                    "render": function (el) {
                        new Ext.dd.DropZone(el.getEl(), {
                            ...
                            onNodeDrop : function (target, dd, e, data) {
                                if (data.node.attributes.type == "folder" && data.node.attributes.elementType=='document') {
