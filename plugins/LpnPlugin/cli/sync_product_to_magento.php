...
$db = \Pimcore\Db::get();
$sql = "SELECT cid,ean FROM element_workflow_state LEFT JOIN object_5 ON element_workflow_state.cid = object_5.oo_id WHERE state = 'needs_magento_sync' AND status!='new' and actif_web=1 and obsolete IS NULL LIMIT 64";
