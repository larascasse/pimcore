...
$conditionFilters = array(
    "o_path LIKE '/catalogue/_product_base__/50finition/teintes/teinte-reactive-mordant%'",
    "ean IS NOT NULL"
...
foreach ($list->getObjects() as $object) {
   ...
   $parentSuffixe = str_ireplace("Brule","brulé",$parentSuffixe);
   $parentSuffixe = str_ireplace("chateau","chateau",$parentSuffixe);
   $parentSuffixe = str_ireplace("fume","fumé",$parentSuffixe);
